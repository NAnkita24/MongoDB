...
db.products.updateOne({price:899} ,{$set:{'stock':24}})

db.products.updateOne({'price':899} ,{$rename:{'category':'Phones'}})
db.products.updateOne({'brand':'Apple'},{$unset:{price:1}})
db.products.deleteMany({price:499})
db.products.find({price:{$gt:300}}).count()
db.products.find({price:{$gt:300}}).execution()
